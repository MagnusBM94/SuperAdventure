    ...
    public partial class SuperAdventure : Form
    {
        ...
        private void MoveTo(Location newLocation)
        {
                ...
                if (playerAlreadyHasQuest)
                {
                    if (!playerAlreadyCompletedQuest)
                    {
                        bool playerHasAllItemsToCompleteQuest =
                            _player.HasQuestCompletionItems(newLocation.QuestAvailableHere);
                        if (playerHasAllItemsToCompleteQuest)
                        {
                            ...
                            rtbMessages.Text += "Your receive: " + Environment.NewLine;
            ...
            foreach(InventoryItem ii in _player.Inventory)
            {
                if(ii.Quantity > 0)
                {
                    dgvInventory.Rows.Add(new[] { ii.Details.Name,
            ...
            {
                dgvQuests.Rows.Add(new[] {pq.Details.Name,
